...
class Griding:
    def __init__(self,raiz,asd):
        self.raiz = raiz
        self.nome1='alt'
        self.raiz.title(self.nome1)
        Label(self.raiz,text=asd).grid(row=1, column=1,sticky=W, pady=3)
        Label(self.raiz,text=asd).grid(row=2, column=1,sticky=W, pady=3)
